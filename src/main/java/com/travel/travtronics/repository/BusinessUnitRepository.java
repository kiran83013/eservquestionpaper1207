...
public interface BusinessUnitRepository extends JpaRepository<BusinessUnit, Long>{
	...
	@Query(value = "SELECT bu.BusinessUnitId AS businessUnitId, bu.AccCode AS accCode, bu.Name AS name, bu.OrganizationId AS organizationId, \r\n" + 
			...
			"bu.Attr15 AS attr15, bu.Attr16 AS attr16, bu.Attr17 AS attr17, bu.Attr18 AS attr18, bu.Attr19 AS attr19,  bu.Attr20 AS attr20 FROM business_unit bu\r\n" + 
			"LEFT JOIN master_organization mo ON mo.OrganizationId = bu.OrganizationId WHERE bu.OrganizationId =?1",nativeQuery = true)
	List<Map<String, String>> findByList(Long organizationId);

	Page<BusinessUnit> findByOrganizationId(Long organizationId, Pageable pageable);
