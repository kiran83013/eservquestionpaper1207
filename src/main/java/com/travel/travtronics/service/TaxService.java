...
import com.travel.travtronics.model.MasterTaxCategory;
...
import com.travel.travtronics.repository.MasterTaxCategoryRepository;
import com.travel.travtronics.repository.TaxHeaderRepository;
import com.travel.travtronics.repository.TaxLinesRepository;
...
//		}
		...
		Pageable pageable = PageRequest.of(pageNo, pageSize);
		Page<TaxSlabHeader> findByOrganizationId = esCustomRepository.fetchTaxPagination(taxCategory,
